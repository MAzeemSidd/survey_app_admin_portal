...
const MainResponses = React.lazy(() => import('./components/responses/MainResponses'))
const EmployeeResponses = React.lazy(()=>import('./components/responses/EmployeeResponses'))
...
const routes = [
    ...
    { path: '/responses', name: 'Responses', element: MainResponses },
    { path: '/responses/employee', name: 'Employee Responses', element: EmployeeResponses },
]
